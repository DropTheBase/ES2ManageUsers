...
public class White_Box {
    ...
    @Test
    @Order(1)
    public void WB_User_Create_Valid(){
    ...
    @Test
    public void WB_User_Delete_Email_That_Not_exist(){
        User_Connection user_connection = new Mock();
        User user = null;
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("email","teste3@hotmail.com");
        try {
            user_connection.Delete_User(jsonObject);
        } catch (Exception e) {
    ...
    @Test
    @Order(3)
    public void WB_User_Update_By_Email_All_Data(){
        User_Connection user_connection = new Mock();
        User user = null;
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("email","teste_novo@hotmail.com");
        jsonObject.put("first","Teste");
        jsonObject.put("last","Teste");
        jsonObject.put("avatar","teste.png");
        jsonObject.put("email_novo","teste2@hotmail.com");
        try {
            user_connection.Update_User(jsonObject);
            assertTrue(true);
        } catch (Exception e) {
    ...
    @Test
    @Order(4)
    public void WB_User_Update_By_Email_But_Not_Change_Data(){
        User_Connection user_connection = new Mock();
        User user = null;
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("email","teste2@hotmail.com");
        try {
            user_connection.Update_User(jsonObject);
        } catch (Exception e) {
            assertEquals("Invalid Data", e.getMessage());
    ...
    @Test
    @Order(4)
    public void WB_User_Update_By_Email_But_First_Name_Invalid(){
        User_Connection user_connection = new Mock();
        User user = null;
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("email","teste2@hotmail.com");
    ...
    @Test
    @Order(4)
    public void WB_User_Update_By_Email_But_Last_Name_Invalid(){
        User_Connection user_connection = new Mock();
        User user = null;
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("email","teste2@hotmail.com");
    ...
    @Test
    @Order(4)
    public void WB_User_Update_By_Email_But_Avatar_invalid(){
        User_Connection user_connection = new Mock();
        User user = null;
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("email","teste2@hotmail.com");
    ...
    @Test
    @Order(4)
    public void WB_User_Update_By_Email_But_New_Email_Invalid(){
        User_Connection user_connection = new Mock();
        User user = null;
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("email","teste2@hotmail.com");
    ...
    @Test
    @Order(4)
    public void WB_User_Update_By_Email_But_New_Email_Less_Then_Min(){
        User_Connection user_connection = new Mock();
        User user = null;
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("email","teste2@hotmail.com");
    ...
    @Test
    @Order(4)
    public void WB_User_Update_By_Email_Inexistent_And_Not_Change_Data(){
        User_Connection user_connection = new Mock();
        User user = null;
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("email","teste_invalido@hotmail.com");
        try {
            user_connection.Update_User(jsonObject);
        } catch (Exception e) {
            assertEquals("Invalid Email", e.getMessage());
