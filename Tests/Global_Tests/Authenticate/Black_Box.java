...
public class Black_Box {
    ...
    public void BB_Register_Email_Equal_To_Max(){
        Authenticate_connection authenticate_connection = new App();
        try {
            Authenticate authenticate = new Authenticate("123456789123456789123456789123456789123456789@o.pt","P12345678");
            authenticate_connection.Register(authenticate);
            assertTrue(true);
        } catch (Exception e) {
        }
    ...
    public void BB_Register_Email_More_Then_Max(){
        Authenticate_connection authenticate_connection = new App();
        try {
            Authenticate authenticate = new Authenticate("123456789123456789123456789123456789123456789@hotmail.com","P12345678");
            authenticate_connection.Register(authenticate);
        } catch (Exception e) {
            assertEquals("Invalid Data", e.getMessage());
        }
    ...
    public void BB_Register_Pass_More_Then_Max(){
        Authenticate_connection authenticate_connection = new App();
        try {
            Authenticate authenticate = new Authenticate("teste@hotmail.com","P12345678912345678912");
            authenticate_connection.Register(authenticate);
        } catch (Exception e) {
            assertEquals("Invalid Data", e.getMessage());
        }
    ...
    public void BB_Register_Pass_Equal_To_Max(){
        Authenticate_connection authenticate_connection = new App();
        try {
            Authenticate authenticate = new Authenticate("teste@hotmail.com","P1234567891234567891");
            authenticate_connection.Register(authenticate);
            assertTrue(true);
        } catch (Exception e) {
        }
    ...
    public void BB_Register_Pass_Less_Then_Min(){
        Authenticate_connection authenticate_connection = new App();
        try {
            Authenticate authenticate = new Authenticate("teste@hotmail.com","P123456");
            authenticate_connection.Register(authenticate);
        } catch (Exception e) {
            assertEquals("Invalid Data", e.getMessage());
        }
    ...
    public void BB_Register_Pass_Null(){
        Authenticate_connection authenticate_connection = new App();
        try {
            Authenticate authenticate = new Authenticate("teste@hotmail.com",null);
            authenticate_connection.Register(authenticate);
        } catch (Exception e) {
